...
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (1, "Whole Wheat", "N/A", "wholeWheat", "Also referred to as 'wholemeal bread' outside the US. This type is made from flour that is milled (partially or entirely) from whole wheat grains. Depending on where you buy your whole wheat bread from, actual wheat germ content may vary. Most wheat bread you see in stores is actually white bread that has added caramel coloring.");
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (2, "White", "N/A", "white", "This bread is made from wheat flour that has had it's germ layers removed during milling. Since these germ layers prohibit longer shelf lives, white bread is able to last much longer. Fun fact! After the introduction of certain mandates made by the government made in the mid 1900's, white bread has contributed to a major decline in nutrition deficiencies in the US due to added acid fortifications to make it more nutritious.");
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (3, "Italian", "Ciabatta, Focaccia, Filoncino, Rosetta, Grissini, Piadina, Freselle, Schiaccia, Taralli", "italian", "Italian bread is known for its thin crust and moist interior. While wheat flour is an essential ingredient, different compositions of yeast, lard, salt, and oils make for an assormtent of different kinds. Served alongside other foods, the absorbancy of italian bread can be used to soak up oils and sauces.");
...
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (5, "Raisin", "N/A", "raisin", "Raisin bread is one of the sweeter inclusions that is commonly consumed in the US. It's fairly easy to find the defining factor that makes this type unique...Raisin! Due to the aesthetic of a sliced piece of raisin bread, many have used it to describe an assortment of scientific phenomena, ranging from the expansion of the universe to the appearance of an atom.");
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (6, "Sourdough", "N/A", "sourdough", "Sourdough distinguishes itself from others due to it's sour taste that is not commonly found in other breads. This sourness, to put it most simply comes from letting the dough ferment.<br>");
INSERT INTO `CatalogClassic` (`BreadID`, `Name`, `Additional`, `Path`, `Description`) VALUES (7, "Cinnamon", "N/A", "cinnamon", "More of a confectionary than something you'd want to use for your sandwich, cinnamon bread is widely made of the same basic ingredients of other common breads, but with a whole bunch of cinnamon, making for a tasty treat.");
